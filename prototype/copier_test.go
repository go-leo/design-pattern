...
//	employee := Employee{}
//
//	if err := prototype.Clone(employee, &user); err == nil {
...
//	employees := []Employee{}
//
//	if err := prototype.Clone(employees, &user); err != nil && len(employees) != 0 {
//		t.Errorf("Copy to unaddressable value should get error")
//	}
//
//	if prototype.Clone(&employees, &user); len(employees) != 1 {
...
//
//	employees2 := &[]Employee{}
//	if prototype.Clone(&employees2, user); len(*employees2) != 1 {
//		t.Errorf("Should only have one elem when copy struct to slice")
//	} else {
...
//
//	employees3 := []*Employee{}
//	if prototype.Clone(&employees3, user); len(employees3) != 1 {
//		t.Errorf("Should only have one elem when copy struct to slice")
//	} else {
...
//
//	employees4 := &[]*Employee{}
//	if prototype.Clone(&employees4, user); len(*employees4) != 1 {
//		t.Errorf("Should only have one elem when copy struct to slice")
//	} else {
...
//	employees := []Employee{}
//
//	if prototype.Clone(&employees, users); len(employees) != 2 {
...
//
//	employees2 := &[]Employee{}
//	if prototype.Clone(&employees2, &users); len(*employees2) != 2 {
//		t.Errorf("Should have two elems when copy slice to slice")
//	} else {
...
//
//	employees3 := []*Employee{}
//	if prototype.Clone(&employees3, users); len(employees3) != 2 {
//		t.Errorf("Should have two elems when copy slice to slice")
//	} else {
...
//
//	employees4 := &[]*Employee{}
//	if prototype.Clone(&employees4, users); len(*employees4) != 2 {
//		t.Errorf("Should have two elems when copy slice to slice")
//	} else {
...
//		if employees3[1] == nil && users[1] == nil {
//			t.Log("Copy From Slice To Ptr Slice Ptr nil, @ 2")
//		}
//
//	}
//
...
//		if employees3[1] == nil && users[1] == nil {
//			t.Log("Copy From Slice Ptr To Double Ptr Slice Ptr nil, @ 2")
//		}
//	}
//}
//
...
//	prototype.Clone(&mockedResult, &expectedResult)
//
...
//	//	}
//	//	to := DriverOptions{}
//	//	if err := prototype.Clone(&to, &from); nil != err {
...
//		}
//
//		m := to.GenOptions["key"].(map[any]any)
//		a := m["Inner"].(map[any]any)
//		a["IntPtr"] = 6
//
//		if to.GenOptions["key"].(map[any]any)["Inner"].(map[any]any)["IntPtr"] == from.GenOptions["key"].(Outer).Inner.IntPtr {
//			t.Errorf("should be different")
//		}
//	})
//
...
//	//	prototype.CloneWithOption(&to, &from, copier.Option{IgnoreEmpty: true, DeepCopy: true})
...
//		}
//
//		to.GenOptions.(map[any]any)["Inner"].(map[any]any)["IntPtr"] = 6
//
//		if to.GenOptions.(map[any]any)["Inner"].(map[any]any)["IntPtr"] == from.GenOptions.(Outer).Inner.IntPtr {
//			t.Errorf("should be different")
//		}
//	})
//}
...
//	err := prototype.Clone(&dst1, src)
//	if err != nil {
//		t.Error("Should not raise error")
//	}
//	err = prototype.Clone(&dst2, src)
//	if err != nil {
//		t.Error("Should not raise error")
//	}
//
...
////	if err := prototype.CloneWithOption(to, &from, copier.Option{IgnoreEmpty: true}); err != nil {
////		t.Error("Should not raise error")
////	}
////
////	if to.A == from.A {
...
//	err := prototype.Clone(&shallow, &src)
//	if err != nil {
